 ...
 */
public class BeautySyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public BeautySyncAdapter(Context context, boolean autoInitialize) {
        super(context, autoInitialize);
    }

    public BeautySyncAdapter(Context context, boolean autoInitialize, boolean allowParallelSyncs) {
        super(context, autoInitialize, allowParallelSyncs);
    }

    @Override
    public void onPerformSync(Account account, Bundle bundle, String s, ContentProviderClient contentProviderClient, SyncResult syncResult) {
        Log.d(BeautyApp.TAG, "Performing Sync.");
        TipModel.getInstance().loadTips();
    }
